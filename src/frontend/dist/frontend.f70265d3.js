parcelRequire = (function(e, r, t, n) {
...
})(
  {
    ...
    YyNO: [
              ...
              i(u, [
                {
                  ...
                  value: function() {
                    ...
                    fetch("/checkToken")
                      ...
                      .catch(function(t) {
                        console.error(t),
                          e.setState({ loading: !1, redirect: !0 });
                      });
                  }
                },
                {
                  ...
                  value: function() {
                    ...
                    return o
                      ? null
                      : u
                      ? e.default.createElement(t.Redirect, { to: "/login" })
                      : e.default.createElement(
                          e.default.Fragment,
                          null,
                          e.default.createElement(r, this.props)
                        );
                  }
                }
              ]),
      ...
      { react: "ccIB", "react-router-dom": "/Cc2" }
    ],
    LQsi: [
      function(require, module, exports) {
        "use strict";
              ...
              s(l(t), "onSubmit", function(e) {
                e.preventDefault(),
                  fetch("/api/authenticate", {
                    ...
                    .then(function(e) {
                      if (200 !== e.status) throw new Error(e.error);
            ...
            u(n, [
              {
                ...
                value: function() {
                  return e.default.createElement(
                    "form",
                    { onSubmit: this.onSubmit },
                    e.default.createElement("h1", null, "Login Below!"),
                    e.default.createElement("input", {
                      name: "username",
            ...
            u(r, [
              {
                ...
                value: function() {
                  ...
                  return e.default.createElement(
                    "form",
                    { onSubmit: this.onSubmit },
                    e.default.createElement("h1", null, "Register Below!"),
                    e.default.createElement("input", {
                      name: "username",
                      placeholder: "Enter username",
                      value: this.state.username,
    ...
    lY9v: [
      function(require, module, exports) {
        ...
        var e = a(require("react")),
          t = require("react-router-dom"),
          r = i(require("./withAuth")),
          n = i(require("./URLSettings")),
          o = i(require("./Settings")),
          u = i(require("./Login")),
          l = i(require("./Register"));
        function i(e) {
          return e && e.__esModule ? e : { default: e };
        }
        function a(e) {
        ...
        var h = (function(i) {
            function a() {
              return f(this, a), d(this, m(a).apply(this, arguments));
            }
            return (
              b(a, e.Component),
              s(a, [
                    ...
                    return e.default.createElement(
                      ...
                      e.default.createElement(
                        ...
                        e.default.createElement(t.Route, {
                          path: "/",
                          exact: !0,
                          component: (0, r.default)(n.default)
                        }),
                        e.default.createElement(t.Route, {
                          path: "/settings",
                          component: (0, r.default)(o.default)
                        }),
                        e.default.createElement(t.Route, {
                          path: "/login",
                          component: u.default
...
//# sourceMappingURL=/frontend.f70265d3.js.map
